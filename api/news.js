...
const NEWS_QUERIES = [
  ...
  },
  {
    ...
    keyword: 'Efteling OR Europa-Park OR "Disneyland Paris" OR Legoland OR Gardaland OR PortAventura OR "Alton Towers" OR "Thorpe Park" OR Energylandia OR Tivoli OR Phantasialand OR "Puy du Fou" OR "Parc Asterix" OR Liseberg OR theme park opening OR water park opening OR new attraction OR roller coaster opening OR "Christmas market" OR festival Europe OR museum opening OR "free museum" OR "open air" OR "summer season opens"',
    count: 80,
  },
  {
    // Travel alerts: flights, strikes, taxes, logistics
    name: 'travel-alerts',
    keyword: '"tourist tax" OR "city tax" tourism OR transport strike Europe OR airport strike OR "flight disruption" OR "new route" Israel OR "direct flight" Israel Europe OR "Ryanair" OR "Wizz Air" OR "easyJet" Israel OR ETIAS OR "low emission zone" OR "airport delay" OR "rail strike" OR "new train" Europe OR "high speed rail" OR "border control" Europe OR "travel warning" Europe',
    count: 70,
  },
];
